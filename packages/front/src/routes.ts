...
import manualDataViewEn from "@m/measurement/manuals/data-view.en.md";
import manualDataViewTr from "@m/measurement/manuals/data-view.tr.md";
...
import { CDataViewProfileAddForm } from "@m/measurement/pages/CDataViewProfileAddForm";
import { CDataViewProfileEditForm } from "@m/measurement/pages/CDataViewProfileEditForm";
import { CDataViewProfileList } from "@m/measurement/pages/CDataViewProfileList";
import { CDataViewProfileValue } from "@m/measurement/pages/CDataViewProfileValue";
...
export const routes = [
  ...
  {
    path: "/measurements/data-view/profile/item-add",
  ...
  {
    path: `/measurements/data-view/profile/item/${":id" as string}`,
  ...
  {
    path: `/measurements/data-view/values/${":profileId" as string}`,
