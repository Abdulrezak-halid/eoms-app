...
import {
  IDtoPipelineRequest,
  IDtoPipelineResponse,
} from "../interfaces/IDtoPipeline";

export function CPipelineForm({
  initialData,
  onSubmit,
}: {
  initialData?: IDtoPipelineResponse;
  onSubmit: (data: IDtoPipelineRequest) => Promise<void>;
}) {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    const body: IDtoPipelineRequest = {
